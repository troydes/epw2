...
#include "f_defs.h"
  ...
  CALL mp_bcast (efprime, root)   !
  CALL mp_bcast (fsthickprime, root)   !
  ...
  CALL mp_bcast (constepm, root)
  CALL mp_bcast (perphon, root)
  CALL mp_bcast (groupq, root)
  CALL mp_bcast (ldoubledelta, root) ! BL
  CALL mp_bcast (ltetra_elec, root) ! BL
  CALL mp_bcast (ltetra_phon, root) ! BL
  !
  ! integers
  !
  ...
  CALL mp_bcast (ndeg, root)
  CALL mp_bcast (nefsweep, root)
  CALL mp_bcast (isefsweep, root)
  CALL mp_bcast (nqgroup, root)
  !
  ! real*8
  !
  ...
  CALL mp_bcast (efsweep, root)  
  CALL mp_bcast (egap0, root) !BL
  !
  ! characters
  !
