...
!  use para
  ...
  real(kind=DP) :: weight, w0g1, w0g1_ , w0g2, wgauss,dosef,          &
       DOs_ef, ef1, lambda, gamma, wq, ekk, ekq, dw, degausswi
...
100  call errore ('elphon', 'opening file'//filelph, abs (ios) )
     rewind (iuelph)
     WRITE (iuelph, 9001) xq, degausswi, ngaussw, 3 * nat, nw, nq
      ...
      DO ibnd = 1, ibndmax-ibndmin+1
        ...
        DO jbnd = 1, ibndmax-ibndmin+1
          ...
          DO iw = 1, nw
            ...
            ENDIF
            !
            cw0g2 =  cone / ( ekq - ekk - wq - ci * degausswi ) / pi
            !
            IF ( selfen_type .eq. 1 ) then
               w0g2 =    real ( cw0g2 ) 
            ELSE 
